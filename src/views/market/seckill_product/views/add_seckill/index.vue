      ...
      <el-col :span="24">
        <el-card class="box-card">
          <div slot="header" class="clearfix">
            <span class="left-border">开启秒杀</span>
            <el-button
              type="primary"
          ...
          >
            <el-row>
              <el-col :span="12">
                <el-form-item label="秒杀名称" prop="seckillSpu.name">
                  <el-input v-model="form.seckillSpu.name" placeholder="默认为商品名称"></el-input>
                </el-form-item>
                <el-form-item label="秒杀简介" prop="seckillSpu.info">
                  <el-input
                    type="textarea"
                    :rows="4"
              ...
              <el-col :span="12">
                <el-form-item label="秒杀价(元)" prop="seckillSpu.seckillPrice">
                  <el-input-number
                    :min="0"
              ...
              <!-- <el-col :span="12">
                <el-form-item label="秒杀人数设置" prop="seckillSpu.peopleCount">
                  <el-input-number
                    :min="0"
              ...
              <el-col :span="12" v-if="form.seckillSpu.activityType === 1">
                <el-form-item label="秒杀折扣" prop="seckillSpu.seckillDiscount">
                  <el-input-number
                    :min="0"
                    :max="100"
