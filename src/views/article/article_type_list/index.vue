		...
		<el-row>
			<el-col :span="24">
				<el-card class="box-card">
					<div class="search">
						<el-input v-model="searchVal" placeholder="搜索分类名称" class="search-input margin-box"  @keyup.native.enter="search"></el-input>
					...
					<el-table ref="table" :max-height="$store.state.tableHeight.tableHeight" :data="articleTypeList" style="width: 100%" @selection-change="handleSelectionChange" :row-key="getRowKey" highlight-current-row stripe>
