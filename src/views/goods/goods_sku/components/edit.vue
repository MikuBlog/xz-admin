<template>
  <el-dialog :visible.sync="dialog" title="编辑商品规格" width="570px" append-to-body v-dialogDrag @close="hideBox">
    <el-form
      status-icon
      ref="form"
      :model="form"
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="editSku" size="small">确认</el-button>
    </div>
  </el-dialog>
</template>
...
export default {
  ...
  methods: {
    submitEnter(e) {
			e.keyCode === 13 && this.dialog === true && this.editSku()
		},
    handleClose(tag) {
