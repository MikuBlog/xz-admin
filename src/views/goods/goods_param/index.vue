		...
		<el-row>
			<el-col :span="24">
				<el-card class="box-card">
					<div class="search">
						<el-input v-model="searchVal" placeholder="搜索参数名" class="search-input margin-box"  @keyup.native.enter="search"></el-input>
            ...
            <el-table-column label="创建日期" width="180">
					...
					<pagination ref="pagination" :get-data="getParamList" :now-page.sync="nowPage" :now-size.sync="nowSize" :total="totalElements" />
				</el-card>
			</el-col>
		</el-row>
