      ...
      <flexbox
        ...
        <div class="file-handle">
          <el-button type="primary"
            @click="$previewFile(bigImgUrl)">预览</el-button>
          <el-button
            type="primary"
            plain
            @click="$download(bigImgUrl)">下载</el-button>
        </div>
      </flexbox>
      <!-- tips -->
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      console.log(this.imgData, this.imgIndex)
      ...
      console.log(this.bigImgUrl, this.bigImgName)
      if (this.imgLength > 1) {
        // 大于1的时候才会展示缩略图
