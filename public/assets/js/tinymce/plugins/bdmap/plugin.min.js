tinymce.PluginManager.add('bdmap', function(editor, url) {
    ...
    console.log(baseURL)
    var iframe1 = '/assets/js/tinymce/plugins/bdmap/map.html';
    ...
    var openDialog = function() {
        return editor.windowManager.openUrl({
            ...
            onAction: function (api, details) {
                switch (details.name) {
                    case 'save':
                        html='<iframe src="/assets/js/tinymce/plugins/bdmap/bd.html?center='+tinymceLng+'%2C'+tinymceLat+'&zoom=14&width='+(bdmap_width(editor)-2)+'&height='+(bdmap_height(editor)-2)+'" frameborder="0" style="width:'+bdmap_width(editor)+'px;height:'+bdmap_height(editor)+'px;">';
